...
<head>
  ...
  <link rel="icon" type="img/png" href="<?php echo base_url();?>assets/img/logo/logo.png">
  ...
  <div class="container-fluid row">
    ...
    <div class="collapse ml-5 col-9 navbar-collapse" id="navbarNav">
      <ul class="navbar-nav mx-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?php echo base_url(); ?>index.php/Akademik/About">About</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?php echo base_url(); ?>index.php/Akademik/Academic">Academics</a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?php echo base_url(); ?>index.php/Presence">Presence</a>
        </li>
      </ul>
    </div>
    <div style="" class="navbar-nav mr-3 col-2">
      <ul class="navbar-nav mx-auto">
        <li class="nav-item">
          <a class="nav-link text-secondary" id = "clock" onload="currentTime()"></a>
        </li>
        <li class="nav-item">
          <a class="fa fa-search text-primary nav-link" aria-hidden="true"></a>
        </li>
        <div class="dropdown">
            <a class="text-primary nav-item nav-link d-none d-lg-block dropdown-toggle" data-bs-toggle="dropdown" data-bs-display="static" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-expanded="false">
                ...
                <table>
                  ...
                  <tr>
                    <td>
                      ...
                      <h6 style="text-align: center;"><?php echo $user_code; ?></h6>
                    </td>
                  </tr>
                </table>
              </a>
