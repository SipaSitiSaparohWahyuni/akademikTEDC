...
<div class="container mt-5 mb-0 p-5 rounded">
	...
	<h3 class="py-3" style="text-align: center;">Tambah Mata Kuliah</h3>
	<form class="signUp" action="<?php echo base_url();?>index.php/AdminAcademic/addMataKuliah/" method="POST" enctype="multipart/form-data">
		<?php 
		  	...
		  	<div class="container px-5">
		  		<div class="row mb-4">
				  	<div class="input-group mb-4">
					  	...
					  	<input type="text" name="matakuliah_name" class="form-control" placeholder="Nama Mata Kuliah" aria-label="Default" aria-describedby="inputGroup-sizing-default" value="">
				  	</div>
				  	<table class="table">
				  		<thead>
