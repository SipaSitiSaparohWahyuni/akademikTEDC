...
<div class="container mt-5 mb-0 p-5 rounded">
	...
	<h3 class="py-3" style="text-align: center;">Update Data Kelas</h3>
	<form class="signUp" action="<?php echo base_url();?>index.php/AdminAcademic/save/<?php echo $data_class->class_id; ?>" method="POST" enctype="multipart/form-data">
		...
		<?php } ?>
			<input type="hidden" name="class_id" value="<?php echo $data_class->class_id; ?>" class="form-control">
		  	...
		  	<div class="container px-5">
			  	...
			  	<div class="input-group mb-4">
				  	...
				  	<input type="text" name="class_name" class="form-control" placeholder="Nama Kelas" aria-label="Default" aria-describedby="inputGroup-sizing-default" value="<?php echo ucwords($data_class->class_name);?>">
			  	</div>
